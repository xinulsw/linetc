...
class Pracownik {
public:
	Pracownik(char *, char *, int, int, int, int, int, int); //konstruktor
...
Pracownik::Pracownik(char *pImie, char *pNazwisko, int uDzien, int uMiesiac, int uRok, int zDzien, int zMiesiac, int zRok)
